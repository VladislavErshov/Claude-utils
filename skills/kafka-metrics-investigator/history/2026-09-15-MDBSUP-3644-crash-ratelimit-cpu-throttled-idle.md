...
### Срез 12 брокеров 2026-09-17 (30с дельты, milli-ядер: контейнер / prom-http / kafka_exporter / vector+rscheck / мониторинг-стек %)

| Хост | конт. | prom-http | k.exp | vec+rs | мон.% |
|---|---|---|---|---|---|
| 1.dc | 1273 | 266 | 36 | 22 | 25% |
| 2.dc | 855 | 180 | 34 | 20 | 27% |
| 3.dc | 988 | 215 | 36 | 21 | 28% |
| 1.kc | 1036 | 166 | 40 | 23 | 22% |
| 2.kc | 1613 | 161 | 36 | 21 | 14% |
| 5.kc | 1007 | 185 | 38 | 20 | 24% |
| 2.rc | 1431 | 304 | 40 | 23 | 26% |
| 3.rc | 1071 | 219 | 54 | 21 | 27% |
| 1.sc | 275 | 125 | 50 | 20 | 71% |
| 2.sc | 275 | 134 | 40 | 20 | 71% |
| 5.sc | 752 | 154 | 51 | 20 | 30% |
| 7.sc | 664 | 168 | 45 | 20 | 35% |

- Мониторинг-стек — **константный налог 0.19–0.37 ядра/брокер** (median ~0.25), от трафика почти не зависит; на idle sc = 71% контейнера.
- prometheus-http (JMX exporter) 0.125–0.304, слабо коррелирует с нагрузкой; на 2.rc дороже всех data-plane тредов.
- kafka_exporter 0.034–0.054 — постоянен, на idle-брокерах относительно дороже.
- Экстраполяция на 42 брокера: **~11 vCPU чистого мониторинг-налога** (JMX ~8, kafka_exporter ~1.8, vector+rscheck ~0.9) ≈ 13% гарантий очередей (54+28 vCPU).
- GC-бёрсты в 30с окна опять не попали (механизм 38–43 тредов подтверждён флагами/тредами ранее).
- **Итог «непродового» потребления: ~0.25 ядра/брокер в среднем** (JMX ~0.19 + kafka_exporter ~0.043 + vector/rscheck ~0.021), плюс connection-churn/KRaft-фон ~0.02–0.03 и GC-бёрсты (средний вклад мал, бёрстят квоту). На пустом брокере непродовое = 0.24 из 0.275 контейнера = **87%**; на кластер = **10–11 vCPU ≈ 13% гарантий (82 vCPU)** даже при нуле клиентов.
