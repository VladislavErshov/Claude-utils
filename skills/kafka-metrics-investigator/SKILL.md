...
- `commands/cloud_metrics.md` — облачные CPU/vcores-метрики Porto через `mcc status` очереди (utilization/demand/allocated — источник цифр UI/goc), без доступа к Grafana/VictoriaMetrics.
