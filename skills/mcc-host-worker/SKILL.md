...
- [commands/perf.md](commands/perf.md) — CPU-профайлер из облака: `mcc perf` (движок perf, формат `f(level,left,width,type,'title')`), парсинг флеймграфа, грабли jattach/[unknown].
